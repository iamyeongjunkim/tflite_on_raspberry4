...
inline const char *EnumNameTensorType(TensorType e) {
  if (e < TensorType_FLOAT32 || e > TensorType_STRING) return "";
...
inline const BuiltinOperator (&EnumValuesBuiltinOperator())[31] {
...
inline const char *EnumNameBuiltinOperator(BuiltinOperator e) {
  if (e < BuiltinOperator_ADD || e > BuiltinOperator_EMBEDDING_LOOKUP_SPARSE) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const BuiltinOptions (&EnumValuesBuiltinOptions())[22] {
...
inline const char *EnumNameBuiltinOptions(BuiltinOptions e) {
  if (e < BuiltinOptions_NONE || e > BuiltinOptions_MulOptions) return "";
  const size_t index = static_cast<size_t>(e);
